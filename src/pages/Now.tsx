          ...
          <div id="contact" className="contact-strip reveal">
            <div>
              ...
              <div className="cs-links">
                <a href="mailto:mahajan.ayush9909@gmail.com" className="cs-link" onClick={() => track.emailClick()}>
                ...
                <a href="https://calendly.com/mahajan-ayush9909/30min" target="_blank" rel="noopener noreferrer" className="cs-link" onClick={() => track.calendlyClick()}>
                ...
                <a href="https://wa.me/917206077760?text=Hey%20Ayush%2C%20I%20came%20across%20your%20portfolio" target="_blank" rel="noopener noreferrer" className="cs-link" onClick={() => track.whatsappClick()}>
